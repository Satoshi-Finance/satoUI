            ...
            <div className="col-sm-3">
              <div className="card" style={{ border: "none" }}>
                <div className="card-body">
                  ...
                  <p className="card-text" id="statsCollateralPrice"></p>
                </div>
              </div>
            </div>
            <div className="col-sm-3">
