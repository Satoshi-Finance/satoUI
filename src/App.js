          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="card" style={{ border: "none" }}>
                <div class="card-body">
                  <h5 class="card-title">Total Troves <i class="bi bi-grid-1x2-fill"></i></h5>
            ...
            <div class="col-sm-3">
              <div class="card" style={{ border: "none" }}>
                <div class="card-body">
                  ...
                  >
                    System TCR <i class="bi bi-speedometer"></i>
                  </h5>
            ...
            <div class="col-sm-3">
              <div class="card" style={{ border: "none" }}>
                <div class="card-body">
                  <h5 class="card-title">Collateral Price <i class="bi bi-fire"></i></h5>
            ...
            <div class="col-sm-3">
              <div class="card" style={{ border: "none" }}>
                <div class="card-body">
                  ...
                  >
                    LP Mining <i class="bi bi-lightning-charge-fill"></i>
                  </h5>
